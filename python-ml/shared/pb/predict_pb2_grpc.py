...
class PredictionServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/aegis.predict.PredictionService/Predict',
...
def add_PredictionServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'aegis.predict.PredictionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('aegis.predict.PredictionService', rpc_method_handlers)
